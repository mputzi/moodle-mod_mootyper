...
$string['attachment_help'] = 'You can optionally attach one or more files to an exercise.';
...
$string['eaddnew'] = 'Add new lesson with an exercise';
...
$string['entry'] = 'Entry - temp string: ';
...
$string['mootypercmerror'] = 'Course Module ID was incorrect';
$string['mootypercmmisconfig'] = 'Course is misconfigured';

$string['mootypexerciseererror'] = 'You must specify an exercise ID';
