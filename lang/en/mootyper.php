...
$string['audiolabel'] = 'Dictation audio:';
$string['audionone'] = 'No audio:';
$string['audiotexttotype'] = 'Record audio here:';
...
$string['defaulttextalign_help'] = 'Set text alignment for new exercises to left, center, or right.';
$string['defaulteditalign'] = 'Edit text alignment';
$string['defaulteditalign_help'] = 'Set default text alignment while editing exercises to left, center, or right.';
...
$string['eaddnew'] = 'Add new exercise / lesson';
$string['eaddnewex'] = 'Add new exercise to this lesson, ID: ';
$string['editable'] = 'Can edit';
$string['editable_help'] = 'This determines who can edit this lesson.';
...
$string['fnewexercise_help'] = 'You can start a new Lesson category, or select an exiting Lesson and add an exercise to it.';
...
$string['visibility_help'] = 'This determines who can see the lesson.';
