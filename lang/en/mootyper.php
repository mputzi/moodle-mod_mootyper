...
$string['eaddnewex'] = 'Add new exercise to this lesson.';
...
$string['fmode'] = 'Mode';
$string['fmode_help'] = 'Lesson mode will present each exercise in a Lesson/Category until all are completed. Exam mode will show only the selected exercise for the exam. Practice mode works the same as Lesson mode, but students can remove grades and repeat exercises. Once you click Save and display, you cannot change the mode.';
$string['fnewexercise'] = 'Exercise will be a part of';
$string['fnewlesson'] = 'create new lesson/category';
...
$string['mootyper:editcategory'] = 'Edit category';
...
$string['mootyper:viewcategory'] = 'View category';
