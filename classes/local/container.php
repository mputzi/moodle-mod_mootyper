...
use mod_mootyper\local\factories\manager as manager_factory;
use mod_mootyper\local\factories\vault as vault_factory;
use mod_mootyper\local\factories\builder as builder_factory;
use mod_mootyper\local\factories\url as url_factory;
...
class container {
    ...
    public static function get_builder_factory() : builder_factory {
        ...
        return new builder_factory(
            ...
            self::get_vault_factory(),
            self::get_manager_factory(),
            $PAGE->get_renderer('mod_mootyper')
        );
    }
