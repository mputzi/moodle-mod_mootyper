...
/**
 * The mod_mootyper exercise added event.
 *
...
/**
 * The mod_mootyper exercises added event class.
 *
 * @package    mod_mootyper
 * @copyright  2016 AL Rachels drachels@drachels.com
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class exercise_added extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('exercise_added', 'mod_mootyper');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' added 'mootyper' exercise number '{$this->other['exercisename']}',
            to lesson '{$this->other['lesson']}', while in the course with id '$this->contextinstanceid'.";
    }
