...
class exercise_completed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' completed exercise'{$this->other['exercise']}', in lesson '{$this->other['lessonname']}' 
             in MooTyper '{$this->other['activity']}', which is course module id '$this->contextinstanceid'.";
    }
