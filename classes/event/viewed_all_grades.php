...
/**
 * The mod_mootyper viewed all grades event.
 *
...
/**
 * The mod_mootyper viewed all grades class.
 *
 * @package    mod_mootyper
 * @copyright  2016 AL Rachels drachels@drachels.com
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class viewed_all_grades extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('mootyper:viewgrades', 'mod_mootyper');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed all grades for lesson/category '$this->other',
            while in the 'mootyper' activity with course module id '$this->contextinstanceid'.";
    }
