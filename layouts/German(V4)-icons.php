...
/**
 * This file defines the German(V4.1)-icons keyboard layout.
 *
...
?>
"><br>
<div id="keyboard" class="keyboardback"><br>
    <section>
    ...
    <div style="float: left;">
        ...
        <span id="jkeyenter" class="normal" style="width: 50px; margin-right:5px; float: right; height: 85px; font-size: 25px">&#9166;</span>
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
        ...
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
            ...
            <div id="jkeyshiftd" class="normal" style="width: 105px; border-right-style: solid;">&#8679;</div>
        </div>
        <div class="mtrow" style='float: left; margin-left:5px;font-size: 15px !important; line-height: 15px'>
