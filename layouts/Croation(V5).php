...
/**
 * This file defines the Croation(V5.1) keyboard layout.
 *
		...
		<section>
			...
			<div style="float: left;">
				<div class="mtrow"
					...
					<div id="jkeyš" class="normal" style='text-align: left;'>
						Š<br>&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">÷</span>
					</div>
					<div id="jkeyđ" class="normal" style='text-align: left;'>
						Đ<br>&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">×</span>
					</div>
				</div>
				...
				<div class="mtrow"
					...
					<div id="jkeyč" class="finger4" style='text-align: left;'>
						Č<br>&nbsp;
					</div>
					<div id="jkeyć" class="normal" style='text-align: left;'>
						Ć<br>&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">ß</span>
					</div>
					<div id="jkeyž" class="normal" style='text-align: left;'>
						Ž<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">¤</span>
					</div>
				</div>
			</div>
			<div class="mtrow"
				...
				<div id="jkeym" class="normal" style='text-align: left;'>
					M<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">§</span>
				</div>
			...
			<div class="mtrow"
				...
				<div id="jkeyaltgr" class="normal" style="width: 50px;">
