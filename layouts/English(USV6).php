...
/**
 * This file defines the English(USV6)keyboard layout. Shift keys
...
?>
">
<div id="keyboard" class="keyboardpadback">English(USV6) Keyboard Layout<br>
    <section>
        ...
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
            ...
            <div id="jkey9" class="normal" style='text-align:left;'>9<br>&nbsp;</div>        </div>
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
