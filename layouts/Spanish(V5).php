...
">
	<div id="keyboard" class="keyboardback">
		Español(V5) Diseño del teclado<br>
		<section>
			<div class="mtrow"
			...
			<div style="float: left;">
				...
				<div class="mtrow"
					...
					<div id="jkeycaps" class="normal"
						style="width: 80px; font-size: 12px !important;">Bloq. mayús</div>
					...
					<div id="jkeyñ" class="finger4" style='text-align: left;'>
						Ñ<br>&nbsp;
					</div>
			...
			<div class="mtrow"
				...
				<div id="jkeyshiftl" class="normal"
					style="width: 70px; font-size: 12px !important;">Mayús</div>
				...
				<div id="jkeyshiftr" class="normal"
					style="width: 105px; font-size: 12px !important;">Mayús</div>
			</div>
			<div class="mtrow"
				style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
