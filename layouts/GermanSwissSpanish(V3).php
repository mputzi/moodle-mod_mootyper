...
/**
 * This file defines the German(SwissV3) from Spanish(V3) keyboard layout.
 *
...
?>
"><br>
<span id="keyboard" class="keyboardback">German(SwissV3) from Spanish(V3) Keyboard Layout<br><br>
...
<span id="jkeypow" class="normal"><span class="textup">`</span><span class="textdown"> ^</span>
    <span class="textdown" style="color:red">~</span></span>
...
<span id="jkeyy" class="normal">Z</span>
...
<span id="jkeylefttick" class="normal"><span class="textup">è</span><span class="textdown">ü</span>
    <span class="textdown" style="color:blue">[</span></span>
...
<span id="jkeyñ" class="finger4"><span class="textup">é</span><span class="textdown"> ö</span></span>
<span id="jkeyrighttick" class="normal"><span class="textup">à</span><span class="textdown">ä</span>
    <span class="textdown" style="color:blue"> {</span></span>
<span id="jkeyç" class="normal"><span class="textup">£</span><span class="textdown">$</span>
    <span class="textdown" style="color:blue">}</span></span>
</div>
...
<span id="jkeyckck" class="normal"><span class="textup">&lt;</span><span class="textdown"> &gt; </span>
    <span class="textdown" style="color:blue">\</span></span>
<span id="jkeyz" class="normal">Y</span>
