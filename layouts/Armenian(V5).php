...
/**
 * This file defines the Armenian(V5.2)keyboard layout.
 *
...
">
	<div id="keyboard" class="keyboardback">
		հայերեն(V5) Ստեղնաշարի դասավորությունը<br>
		<section>
			<div class="mtrow"
			...
			<div class="mtrow"
				...
				<div id="jkeyք" class="normal" style='text-align: left;'>
					Q<br>ք&nbsp;
				</div>
				<div id="jkeyո" class="normal" style='text-align: left;'>
					W<br>ո&nbsp;
				</div>
				<div id="jkeyե" class="normal" style='text-align: left;'>
					E<br>ե&nbsp;
				</div>
				<div id="jkeyռ" class="normal" style='text-align: left;'>
					R<br>ռ&nbsp;
				</div>
				<div id="jkeyտ" class="normal" style='text-align: left;'>
					T<br>տ&nbsp;
				</div>
				<div id="jkeyը" class="normal" style='text-align: left;'>
					Y<br>ը&nbsp;
				</div>
				<div id="jkeyւ" class="normal" style='text-align: left;'>
					U<br>ւ&nbsp;
				</div>
				<div id="jkeyի" class="normal" style='text-align: left;'>
					I<br>ի&nbsp;
				</div>
				<div id="jkeyօ" class="normal" style='text-align: left;'>
					O<br>օ&nbsp;
				</div>
				<div id="jkeyպ" class="normal" style='text-align: left;'>
					P<br>պ&nbsp;
				</div>
				<div id="jkeyխ" class="normal" style='text-align: left;'>
					{<br>խ
				</div>
				<div id="jkeyծ" class="normal" style='text-align: left;'>
					}<br>ծ
				</div>
				<div id="jkeyշ" class="normal"
			...
			<div class="mtrow"
				...
				<div id="jkeyա" class="finger4" style='text-align: left;'>
					A<br>ա&nbsp;
				</div>
				<div id="jkeyս" class="finger3" style='text-align: left;'>
					S<br>ս&nbsp;
				</div>
				<div id="jkeyդ" class="finger2" style='text-align: left;'>
					D<br>դ&nbsp;
				</div>
				<div id="jkeyֆ" class="finger1" style='text-align: left;'>
					F<br>ֆ&nbsp;
				</div>
				<div id="jkeyգ" class="normal" style='text-align: left;'>
					G<br>գ&nbsp;
				</div>
				<div id="jkeyհ" class="normal" style='text-align: left;'>
					H<br>հ&nbsp;
				</div>
				<div id="jkeyյ" class="finger1" style='text-align: left;'>
					J<br>յ&nbsp;
				</div>
				<div id="jkeyկ" class="finger2" style='text-align: left;'>
					K<br>կ&nbsp;
				</div>
				<div id="jkeyլ" class="finger3" style='text-align: left;'>
					L<br>լ&nbsp;
				</div>
				<div id="jkeysemicolon" class="finger4" style='text-align: left;'>
					:<br>;
				</div>
				<div id="jkey՛" class="normal" style='text-align: left;'>
					"<br>՛
			...
			<div class="mtrow"
				...
				<div id="jkeyզ" class="normal" style='text-align: left;'>
					Z<br>զ&nbsp;
				</div>
				<div id="jkeyղ" class="normal" style='text-align: left;'>
					X<br>ղ&nbsp;
				</div>
				<div id="jkeyց" class="normal" style='text-align: left;'>
					C<br>ց&nbsp;
				</div>
				<div id="jkeyվ" class="normal" style='text-align: left;'>
					V<br>վ&nbsp;
				</div>
				<div id="jkeyբ" class="normal" style='text-align: left;'>
					B<br>բ&nbsp;
				</div>
				<div id="jkeyն" class="normal" style='text-align: left;'>
					N<br>ն&nbsp;
				</div>
				<div id="jkeyմ" class="normal" style='text-align: left;'>
					M<br>մ&nbsp;
				</div>
