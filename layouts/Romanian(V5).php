...
">
	<div id="keyboard" class="keyboardback">
		Romanian(V5) Keyboard Layout<br>
		<section>
			<div class="mtrow"
				...
				<div id="jkey7" class="normal" style='text-align: left;'>
					&amp<br>7 <span style="color: red">&nbsp;&nbsp;&nbsp;`</span>
				</div>
				...
				<div id="jkeyminus" class="normal" style='text-align: left;'>
					_&nbsp;&nbsp;&nbsp;–<br>- <span style="color: red">&nbsp;&nbsp;&nbsp;¨</span>
				</div>
			...
			<div style="float: left;">
				<div class="mtrow"
					...
					<div id="jkeyă" class="normal" style='text-align: left;'>
						Ă <span style="color: blue">&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[
						</span>
					</div>
					<div id="jkeyî" class="normal" style='text-align: left;'>
						Î <span style="color: blue">&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]
						</span>
					</div>
				...
				<div class="mtrow"
					...
					<div id="jkeyl" class="finger3" style='text-align: left;'>
						L&nbsp;&nbsp; <span style="color: blue">Ł<br>&nbsp;&nbsp;
						</span>
					</div>
					<div id="jkeyș" class="finger4" style='text-align: left;'>
						Ș&nbsp;&nbsp;&nbsp; <span style="color: blue">:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;;
						</span>
					</div>
					<div id="jkeyț" class="normal" style='text-align: left;'>
						Ț&nbsp;&nbsp;&nbsp; <span style="color: blue">"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
						</span>
					</div>
			...
			<div class="mtrow"
				...
				<div id="jkeyc" class="normal" style='text-align: left;'>
					C<br>&nbsp;&nbsp;&nbsp; <span style="color: blue">©</span>
				</div>
