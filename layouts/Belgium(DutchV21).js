...
function keyboardElement(ltr) {
    ...
    if (ltr === '\\' || ltr === '|' || ltr === '@' || ltr === '#' || ltr === '€' || ltr === '{' || ltr === '}' ||
        ltr === '[' || ltr === ']' || ltr === '~' || ltr === '´' || ltr === '`' || ltr === 'ñ') {
        this.shift = false;
        this.alt = true;
        this.accent = false;
    }
    if (ltr === 'ë' || ltr === 'ï' || ltr === 'ö' || ltr === 'ü') {
        this.shift = true;
        this.alt = false;
        this.accent = false;
        this.caret = true;
...
function dobiFinger(t_crka) {
    if (t_crka === ' ') {
        ...
        return 4; // Highlight the correct key above in red.
               ...
               t_crka === 'ç' || t_crka === '9' || t_crka === '{' || t_crka === 'o' || t_crka === 'ó' || t_crka === 'ö' ||
               t_crka === 'l' || t_crka === ';' || t_crka === '.') {
        return 3; // Highlight the correct key above in green.
    } else if (t_crka === '"' || t_crka === '3' || t_crka === '#' || t_crka === 'e' || t_crka === 'é' || t_crka === 'ë' || t_crka === '€' || t_crka === 'ê' ||
               t_crka === 'd' || t_crka === 'x' || t_crka === '!' || t_crka === '8' || t_crka === 'i' || t_crka === 'í' || t_crka === 'ï' ||
               t_crka === 'k' || t_crka === ',' || t_crka === '?') {
        return 2; // Highlight the correct key above in yellow.
               ...
               t_crka === 'è' || t_crka === '7' || t_crka === 'u' || t_crka === 'ú' || t_crka === 'ü' || t_crka === 'j' || t_crka === 'n' || t_crka === 'ñ') {
