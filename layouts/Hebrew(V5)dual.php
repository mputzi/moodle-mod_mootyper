...
/**
 * This file defines the Hebrew(V5.1)dual keyboard layout.
 *
	...
	<div id="keyboard" class="keyboardback">
		...
		<section>
			...
			<div class="mtrow"
				...
				<div id="jkeycolon" class="finger4" style='text-align: left;'>
					:<br>&nbsp; &nbsp; &nbsp;ף
				</div>
			...
			<div class="mtrow"
				...
				<div id="jkeyץ" class="normal" style='text-align: left;'>
					<b>&gt;<br>&nbsp; &nbsp;&nbsp;ץ
					</b>
				</div>
				<div id="jkeyת" class="normal" style='text-align: left;'>
					<b>&lt;<br>&nbsp; &nbsp;&nbsp;ת
					</b>
				</div>
