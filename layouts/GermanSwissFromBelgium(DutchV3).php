...
/**
 * This file defines the German(Swiss) from Belgium(DutchV3) keyboard layout.
 *
...
?>
"><br>
<span id="keyboard" class="keyboardback">German(Swiss) from Belgium(DutchV3) Keyboard Layout<br><br>
