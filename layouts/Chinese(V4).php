...
/**
 * This file defines the Chinese(V4)keyboard layout.
 *
...
?>
">
<div id="keyboard" class="keyboardback">Chinese(V4) Keyboard Layout<br>
    <section>
        ...
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
            ...
            <div id="jkeyq" class="normal">去全</div>
            <div id="jkeyw" class="normal">我为</div>
            <div id="jkeye" class="normal">俄额</div>
            <div id="jkeyr" class="normal">日人</div>
            <div id="jkeyt" class="normal">他</div>
            <div id="jkeyy" class="normal">一有</div>
            <div id="jkeyu" class="normal">uu</div>
            <div id="jkeyi" class="normal">i</div>
            <div id="jkeyo" class="normal">哦</div>
            <div id="jkeyp" class="normal">怕</div>
        ...
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
            ...
            <div id="jkeyz" class="normal">在中</div>
            <div id="jkeyx" class="normal">下想</div>
            <div id="jkeyc" class="normal">从才</div>
            <div id="jkeyv" class="normal">v</div>
            <div id="jkeyb" class="normal">吧不</div>
            <div id="jkeyn" class="normal">你呢</div>
            <div id="jkeym" class="normal">吗没</div>
