...
/**
 * This file defines the Belgium(DutchV5.2) keyboard layout.
 *
		...
		<section>
			<div class="mtrow"
				...
				<div id="jkey6" class="normal" style='text-align: left;'>
					6<br>§ <span style="color: pink">&nbsp;&nbsp;^</span>
				</div>
				...
				<div id="jkeyparenr" class="normal">
					°<br>)
				</div>
			...
			<div style="float: left;">
				<div class="mtrow"
					...
					<div id="jkeycaret" class="normal" style="text-align: left;">
						<span style="color: pink">¨<br>^<span style="color: blue">&nbsp;&nbsp;
								&nbsp;[</span>
				...
				<div class="mtrow"
					...
					<div id="jkeyù" class="normal" style='text-align: left;'>
						%<br>ù <span style="color: pink">&nbsp;&nbsp;´</span>
					</div>
					<div id="jkeyµ" class="normal" style='text-align: left;'>
						£<br>µ <span style="color: pink">&nbsp;&nbsp;`</span>
					</div>
				</div>
			</div>
			<div class="mtrow"
			...
			<div class="mtrow"
				...
				<div id="jkeyaltgr" class="normal" style="color: blue; width: 50px;">Alt
					Gr</div>
				<div id="jkeyfn" class="normal" style="width: 50px;">Win</div>
