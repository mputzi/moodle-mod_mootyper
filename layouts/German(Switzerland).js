...
function keyboardElement(ltr) {
    ...
    if (isLetter(ltr)) {
        ...
        if (ltr === '°' || ltr === '!' || ltr === '+' || ltr === '"' || ltr === '*' || ltr === 'ç' ||
            ltr === '%' || ltr === '&' || ltr === '/' || ltr === '(' || ltr === ')' || ltr === '=' ||
            ltr === '?' || ltr === ':' || ltr === ';' || ltr === '>' || ltr === '_') {
            this.shift = true;
        } else {
            this.shift = false;
        }
...
function isCombined(chr) {
    return (chr === 'â' || chr === 'î' || chr === 'ô' || chr === 'ê' || chr === 'Ü' || chr === 'Ä' ||
            chr === 'Ö' || chr === 'Ë' || chr === 'Û' || chr === 'Â' || chr === 'Ô' || chr === 'Ê');
}
...
function dobiFinger(t_crka) {
    if (t_crka === ' ') {
        return 5;
    } else if (t_crka === 'q' || t_crka === 'a' || t_crka === 'â' || t_crka === 'p' || t_crka === 'ö' || t_crka === 'ä' ||
              t_crka === 'ü' || t_crka === 'è' || t_crka === 'é' || t_crka === 'à' || t_crka === '$' || t_crka === '¨' ||
              t_crka === 'y' || t_crka === '1' || t_crka === '2' || t_crka === '\'' || t_crka === '+' || t_crka === '?' ||
              t_crka === '@' || t_crka === '\n' || t_crka === '-' || t_crka === '_' || t_crka === '<' || t_crka === '>' ||
              t_crka === '!' || t_crka === '°' || t_crka === 'â') {
        return 4;
    } else if (t_crka === 'w' || t_crka === 's' || t_crka === 'x' || t_crka === ':' || t_crka === 'l' || t_crka === 'o' ||
              t_crka === '0' || t_crka === '3' || t_crka === '#' || t_crka === '=' || t_crka === '.' || t_crka === '*' ||
              t_crka === 'ô') {
        return 3;
    } else if (t_crka === 'd' || t_crka === 'e' || t_crka === 'c' || t_crka === '4' || t_crka === 'k' || t_crka === 'i' ||
              t_crka === '9' || t_crka === ',' || t_crka === ')' || t_crka === ';' || t_crka === 'ç' || t_crka === 'î' ||
              t_crka === 'ê') {
        return 2;
