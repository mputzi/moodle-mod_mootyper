...
/**
 * This file defines the Turkish(V4.2) keyboard layout.
 *
...
">
	<div id="keyboard" class="keyboardback">
		Turkish(V4) Keyboard Layout<br>
		<section>
			<div class="mtrow"
				style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
				<div id="jkeyquote" class="normal" style='text-align: left;'>
				...
				<div id="jkey3" class="normal" style='text-align: left; color: red;'>
					^<br> <span style="color: black">3<span style="color: blue">&nbsp;&nbsp;&nbsp;#</span>
				...
				<div id="jkeyasterick" class="normal" style='text-align: left;'>
			...
			<div style="float: left;">
				<div class="mtrow"
					...
					<div id="jkeyı" class="normal" style='text-align: left;'>
						I<br> <span style="color: blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;i</span>
					</div>
					...
					<div id="jkeyğ" class="normal" style='text-align: left;'>
						Ğ<br> <span style="color: red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¨</span>
					</div>
					<div id="jkeyü" class="normal" style='text-align: left;'>
						Ü<br> <span style="color: red">&nbsp;&nbsp;&nbsp;&nbsp;~</span>
					</div>
				...
				<div class="mtrow"
					...
					<div id="jkeya" class="finger4" style='text-align: left;'>
						A <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: blue">Æ</span>
					</div>
					<div id="jkeys" class="finger3" style='text-align: left;'>
						S <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: blue">ß</span>
					</div>
					...
					<div id="jkeyş" class="finger4" style='text-align: left;'>
						Ş <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red">´</span>
					</div>
					<div id="jkeyeye" class="normal" style='text-align: left;'>
						İ <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</div>
			...
			<div class="mtrow"
				...
				<div id="jkeyç" class="normal" style='text-align: left;'>
					Ç <br>
