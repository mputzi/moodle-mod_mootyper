...
/**
 * This file defines the Belgium(DutchV2.1) keyboard layout.
 *
...
?>
"><br>
<span id="keyboard" class="keyboardback">Belgium(DutchV2.1) Keyboard Layout<br><br>
<span id="jkeytildo" class="normal"><span class="textup">³ </span><span class="textdown">²</span></span>
<span id="jkey1" class="normal"><span class="textup">1</span><span class="textdown">&</span>
    <span class="textdown" style="color:blue"> |</span></span>
<span id="jkey2" class="normal"><span class="textup">2</span><span class="textdown">é</span>
    <span class="textdown" style="color:blue"> @</span></span>
<span id="jkey3" class="normal"><span class="textup">3</span><span class="textdown">"</span>
    <span class="textdown" style="color:blue"> #</span></span>
<span id="jkey4" class="normal"><span class="textup">4</span><span class="textdown">'</span></span>
<span id="jkey5" class="normal"><span class="textup">5</span><span class="textdown">(</span></span>
<span id="jkey6" class="normal"><span class="textup">6</span><span class="textdown">§</span>
    <span class="textdown" style="color:red"> ^</span></span>
<span id="jkey7" class="normal"><span class="textup">7</span><span class="textdown">è</span></span>
<span id="jkey8" class="normal"><span class="textup">8</span><span class="textdown">!</span></span>
<span id="jkey9" class="normal"><span class="textup">9</span><span class="textdown">ç</span>
    <span class="textdown" style="color:blue"> {</span></span>
<span id="jkey0" class="normal"><span class="textup">0</span><span class="textdown">à</span>
    <span class="textdown" style="color:blue"> }</span></span>
...
<span id="jkeycaret" class="normal"><span style="color:red" class="textup">¨ </span>
...
<span id="jkeycolon" class="normal"><span class="textup">/</span><span class="textdown">:</span></span>
<span id="jkeyequal" class="normal"><span class="textup">+ </span><span class="textdown"> =</span>
    <span class="textdown" style="color:red"> ~</span></span>
