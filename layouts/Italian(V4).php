...
/**
 * This file defines the Italian(V4.2) keyboard layout.
 *
	...
	<div id="keyboard" class="keyboardback">
		...
		<section>
			<div class="mtrow"
				...
				<div id="jkeyì" class="normal" style='text-align: left;'>
					^<br>ì
				</div>
			...
			<div style="float: left;">
				<div class="mtrow"
					...
					<div id="jkeyè" class="normal" style='text-align: left;'>
						é&nbsp;&nbsp;&nbsp; <span style="color: red">{</span><br>è&nbsp;&nbsp;&nbsp;&nbsp;<span
				...
				<div class="mtrow"
					...
					<div id="jkeyò" class="finger4" style='text-align: left;'>
						ç<br>ò&nbsp; <span style="color: blue">@</span>
					</div>
					<div id="jkeyà" class="normal" style='text-align: left;'>
						°<br>à&nbsp;&nbsp;&nbsp; <span style="color: blue">#</span>
					</div>
			...
			<div class="mtrow"
				...
				<div id="jkeylessthan" class="normal" style='text-align: left;'>
					&gt;<br>&lt;
				</div>
