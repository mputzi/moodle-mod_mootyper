...
/**
 * This file defines the EnglishWKeypad(USV6)keyboard layout. Shift keys
 * now separated and light up correctly - right shift for upper case
...
<div id="keyboard" class="keyboardpadback">English with Keypad(USV6) Keyboard Layout<br>
    <section>
        ...
        <div id="jkeyenterp" class="normal" style="margin-top:5px; width: 41px; margin-right:5px; float: right; height: 85px;">Enter</div>
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
