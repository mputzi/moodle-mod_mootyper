...
<div id="keyboard" class="keyboardpadback">English with Keypad(USV6) Keyboard Layout<br>
    <section>
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 16px !important; line-height: 16px'>
            ...
            <div id="jkeybackspace" class="normal" style="width: 100px;">Backspace</div>
        ...
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 16px !important; line-height: 16px'>
            ...
            <div id="jkey9p" class="normal" style='text-align:left;'>9<br>&nbsp;</div>        </div>
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 16px !important; line-height: 16px'>
            ...
            <div id="jkeyenter" class="normal" style="width: 100px;">Enter</div>
            <div id="jkeyxxx" class="normalblank" style='text-align:left;'> <br> </div>
        ...
        <div id="jkeyenterp" class="normal" style="margin-top:5px; width: 41px;
        ...
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 16px !important; line-height: 16px'>
            ...
            <div id="jkeyshiftr" class="normal" style="width: 125px;">Shift</div>
            <div id="jkeyxxx" class="normalblank" style='text-align:left;'> <br> </div>
        ...
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 16px !important; line-height: 16px'>
            ...
            <div id="jkeyfn" class="normal" style="width: 60px;">Fn</div>
            <div id="jkeyalt" class="normal" style="width: 60px;">Alt</div>
            <div id="jkeyspace" class="normal" style="width: 295px;">Space</div>
            <div id="jkeyaltgr" class="normal" style="width: 60px;">Alt</div>
            <div id="jkeyfn" class="normal" style="width: 60px;">Fn</div>
            <div id="jkeyctrlr" class="normal" style="width: 60px;">Ctrl</div>
            <div id="jkeyxxx" class="normalblank" style='text-align:left;'> <br> </div>
            <div id="jkey0p" class="normal" style="width: 85px;">0<br>&nbsp;</div>
