...
/**
 * This file defines the German(V5.1)-icons keyboard layout.
 *
...
">
	<div id="keyboard" class="keyboardback">
		German(V5) Keyboard Layout<br>
		<section>
			<div class="mtrow"
				style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
				<div id="jkeypow" class="normal" style='text-align: left;'>
					°<br>
					<span>&nbsp;&nbsp;&nbsp;^</span>
				</div>
				...
				<div id="jkeyß" class="normal" style='text-align: left;'>
					?<br>ß <span style="color: blue">&nbsp;&nbsp;&nbsp;\</span>
				</div>
			...
			<div style="float: left;">
				<div class="mtrow"
					style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
					<div id="jkeytab" class="normal" style="width: 60px;">&#8633;</div>
				...
				<span id="jkeyenter" class="normal"
					style="width: 50px; margin-right: 5px; float: right; height: 85px; font-size: 25px">&#9166;</span>
				<div class="mtrow"
					style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
					<div id="jkeycaps" class="normal" style="width: 80px;">&#8681;</div>
			...
			<div class="mtrow"
				style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
				<div id="jkeyshiftl" class="normal" style="width: 70px;">&#8679;</div>
				...
				<div id="jkeyshiftr" class="normal"
					style="width: 105px; border-right-style: solid;">&#8679;</div>
			</div>
			<div class="mtrow"
				style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
