...
/**
 * This file defines the German(SwissV5.1) keyboard layout.
 *
...
">
	<div id="keyboard" class="keyboardback">
		German(SwissV5) Keyboard Layout<br>
		<section>
			<div class="mtrow"
				style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
				<div id="jkeysection" class="normal" style='text-align: left;'>
					°<br>§
				</div>
			...
			<div style="float: left;">
				<div class="mtrow"
					...
					<div id="jkeyü" class="normal" style='text-align: left;'>
						è<br>ü<span style="color: blue"> &nbsp;&nbsp;&nbsp;[</span>
					</div>
					<div id="jkeyumlaut" class="normal" style='text-align: left;'>
						!<br>
				...
				<div class="mtrow"
					...
					<div id="jkeyumlauta" class="normal" style='text-align: left;'>
						à<br>ä <span style="color: blue">&nbsp;&nbsp;&nbsp;{</span>
					</div>
