...
">
	<div id="keyboard" class="keyboardback">
		Hungarian(V4) Keyboard Layout<br>
		<section>
			<div class="mtrow"
				...
				<div id="jkey2" class="normal" style='text-align: left;'>
					"<br>2 <span style="color: blue">&nbsp;&nbsp;&nbsp;ˇ</span>
				</div>
				...
				<div id="jkeyö" class="normal" style='text-align: left;'>
					Ö<br> <span style="color: blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;˝</span>
				</div>
				<div id="jkeyü" class="normal" style='text-align: left;'>
					Ü<br> <span style="color: blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¨</span>
				</div>
				<div id="jkeyó" class="normal" style='text-align: left;'>
					Ó<br> <span style="color: blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¸</span>
				</div>
			...
			<div style="float: left;">
				<div class="mtrow"
					...
					<div id="jkeyq" class="normal" style='text-align: left;'>
						Q<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">\</span>
					</div>
					...
					<div id="jkeyz" class="normal" style='text-align: left;'>
						Z<br>&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: red"> </span>
					</div>
					<div id="jkeyu" class="normal" style='text-align: left;'>
						U<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">€</span>
					</div>
					<div id="jkeyi" class="normal" style='text-align: left;'>
						I<br>&nbsp;
					</div>
					<div id="jkeyo" class="normal" style='text-align: left;'>
						O<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue"> </span>
					</div>
					<div id="jkeyp" class="normal" style='text-align: left;'>
						P<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue"> </span>
					</div>
					<div id="jkeyő" class="normal" style='text-align: left;'>
						Ő<br>&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">÷</span>
					</div>
					<div id="jkeyú" class="normal" style='text-align: left;'>
						Ú<br>&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">×</span>
					</div>
				</div>
				...
				<div class="mtrow"
					...
					<div id="jkeyk" class="finger2" style='text-align: left;'>
						K<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
							style="color: blue">ł</span>
					</div>
					<div id="jkeyl" class="finger3" style='text-align: left;'>
						L<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">Ł</span>
					</div>
					<div id="jkeyé" class="finger4" style='text-align: left;'>
						É<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">$</span>
					</div>
					<div id="jkeyá" class="normal" style='text-align: left;'>
						Á<br>&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">ß</span>
					</div>
					<div id="jkeyű" class="normal" style='text-align: left;'>
						Ű<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: blue">¤</span>
					</div>
				</div>
			</div>
			<div class="mtrow"
