...
?>
"><br>
<span id="keyboard" class="keyboardback">Dvorak(V2.1) Keyboard Layout<br><br>
...
<span id="jkeyshiftd" class="normal" style="width: 92px;">Shift</span>
<br>
...
<span id="jkeyspace" class="normal" style="width: 300px;">Space</span>
