...
/**
 * This file defines the PortugueseWKeypad(PortugalV6.1) keyboard layout.
 *
...
">
	<div id="keyboard" class="keyboardpadback">
		Layout em português com teclado (Português - V6)<br>
		<table>
			<tr>
				<td style="width: 630px">
					<section>
						<div class="mtrow"
							...
							<div id="jkeyquote" class="normal"
								style='text-align: left; float: left;'>
								»<br>«
							</div>
							<div id="jkeybackspace" class="normal"
								style="width: 90px; float: left;">Backspace</div>
						</div>
						<div style="float: left;">
							<div class="mtrow"
								...
								<div id="jkeyacuteaccent" class="normal"
									style='text-align: left; color: red; float: left;'>
									`<br>´
								</div>
							</div>
							...
							<div class="mtrow"
								...
								<div id="jkeycaps" class="normal"
									style="width: 80px; font-size: 12px !important; float: left;">Caps
									Lock</div>
								...
								<div id="jkeyç" class="finger4"
									style='text-align: left; float: left;'>
									Ç<br>&nbsp;
								</div>
								<div id="jkeyº" class="normal"
									style='text-align: left; float: left;'>
									ª<br>º
								</div>
						...
						<div class="mtrow"
							...
							<div id="jkeyshiftl" class="normal"
								style="width: 70px; float: left;">Shift</div>
							<div id="jkeylessthan" class="normal"
								style='text-align: left; float: left;'>
								&gt;<br>&lt;
							</div>
