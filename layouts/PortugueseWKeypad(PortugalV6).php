...
<table>
    <tr>
        ...
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
            <div id="jkeybackslash" class="normal" style='text-align:left; float: left;'>|<br>\</div>
            ...
            <div id="jkey5" class="normal" style='text-align:left; float: left;'>%<br>5
                <span style="color:blue">&nbsp; &nbsp;€</span></div>
            <div id="jkey6" class="normal" style='text-align:left; float: left;'>&amp <br>6</div>
            ...
            <div id="jkeyquote" class="normal" style='text-align:left; float: left;'>»<br>«</div>
            <div id="jkeybackspace" class="normal" style="width: 90px; float: left;">Backspace</div>
    </div>
    <div style="float: left;">
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
            ...
            <div id="jkeyacuteaccent" class="normal" style='text-align:left; color:red; float: left;'>`<br>´</div>
        </div>
        <span id="jkeyenter" class="normal" style="width: 50px; float: right; height: 85px;">Enter</span>
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
            <div id="jkeycaps" class="normal" style="width: 80px; font-size: 12px !important; float: left;">Caps Lock</div>
            ...
            <div id="jkeyç" class="finger4" style='text-align:left; float: left;'>Ç<br>&nbsp;</div>
            <div id="jkeyº" class="normal" style='text-align:left; float: left;'>ª<br>º</div>
            <div id="jkeytilde" class="normal" style='text-align:left; color:red; float: left;'>^<br>~</div>
        </div>
    </div>

        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
            <div id="jkeyshiftl" class="normal" style="width: 70px; float: left;">Shift</div>
            <div id="jkeylessthan" class="normal" style='text-align:left; float: left;'>&gt;<br>&lt;</div>
            ...
            <div id="jkeyshiftr" class="normal" style="width: 100px; float: left;">Shift</div>
        </div>
        <div class="mtrow" style='float: left; margin-left:5px;'>
            <div id="jkeyctrll" class="normal" style="width: 60px; float: left;">Ctrl</div>
            <div id="jkeywin" class="normal" style="width: 50px; float: left;">Win</div>
            <div id="jkeyalt" class="normal" style="width: 50px; float: left;">Alt</div>
            <div id="jkeyspace" class="normal" style="width: 235px; float: left;">Space</div>
            <div id="jkeyaltgr" class="normal" style="width: 55px; float: left;"><span style="color:blue">Alt Gr</span></div>
            <div id="jkeywin" class="normal" style="width: 50px; float: left;">Win</div>
            <div id="jkeyfn" class="normal" style="width: 50px; float: left;">Menu</div>
