...
/**
 * This file defines the GermanWKeypad(V6.2)-icons keyboard layout.
 *
...
">
	<div id="keyboard" class="keyboardpadback">
		GermanWKeypad(V6) Keyboard Layout<br>
		<table>
			<tr>
					...
					<section>
						<div class="mtrow"
							...
							<div id="jkeybackspace" class="normal"
								style="width: 90px; float: left;">&#9003;</div>
						</div>
						<div style="float: left;">
							<div class="mtrow"
								style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
								<div id="jkeytab" class="normal"
									style="width: 60px; float: left;">&#8633;</div>
							...
							<div class="mtrow"
								...
								<div id="jkeycaps" class="normal"
									style="width: 80px; float: left;">&#8681;</div>
								...
								<div id="jkeyö" class="finger4"
									style='text-align: left; float: left;'>
									Ö<br>&nbsp;
								</div>
								<div id="jkeyä" class="normal"
									style='text-align: left; float: left;'>
									Ä<br>&nbsp;
								</div>
						...
						<div class="mtrow"
							...
							<div id="jkeyshiftl" class="normal"
								style="width: 70px; float: left;">&#8679;</div>
							...
							<div id="jkeyshiftr" class="normal"
								style="width: 100px; float: left; border-right-style: solid;">&#8679;</div>
						</div>
						<div class="mtrow"
							style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
							<div id="jkeyctrll" class="normal"
								style="width: 60px; float: left;">Strg</div>
							...
							<div id="jkeyspace" class="normal"
								style="width: 240px; float: left;">Leertaste</div>
							<div id="jkeyaltgr" class="normal"
								style="color: blue; width: 50px; float: left;">Alt Gr</div>
							<div id="jkeyfn" class="normal" style="width: 50px; float: left;">Fn</div>
				...
				<td style="width: 203px;">
					...
					<div class="mtrow" style='line-height: 15px'>
						<div id="jkeyplusp" class="finger4"
							style="width: 41px; float: right; height: 85px;">+</div>
						<div id="jkeyxxx" class="normalblank"
							style='width: 30px; text-align: left; float: left;'></div>
						<div id="jkey7pp" class="normal"
							style='text-align: left; float: left;'>
							7<br>&nbsp;
						</div>
					...
					<div class="mtrow" style='line-height: 15px'>
						...
						<div id="jkey0p" class="normal"
							style="text-align: left; width: 80px; float: left;">
							0<br>&nbsp;
						</div>
