		...
		<section>
			...
			<div style="float: left;">
				<div class="mtrow"
					...
					<div id="jkeya" class="normal" style='text-align: left;'>
						A<br>&nbsp;
					</div>
					...
					<div id="jkeydollar" class="normal" style="text-align: left;">
						£<br>$ <span style="color: blue">&nbsp;&nbsp;&nbsp;¤
					
					</div>
				</div>
				<span id="jkeyenter" class="normal"
					style="width: 50px; font-size: 12px !important; margin-right: 5px; float: right; height: 85px;">Entrée</span>
				<div class="mtrow"
					style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
					<div id="jkeycaps" class="normal" style="width: 80px;">Verr Maj</div>
					<div id="jkeyq" class="finger4" style='text-align: left;'>
						Q<br>&nbsp;
					</div>
					...
					<div id="jkeym" class="finger4" style='text-align: left;'>
						M<br>&nbsp;
					</div>
					<div id="jkeyù" class="normal" style='text-align: left;'>
						%<br>ù
					</div>
					<div id="jkey*" class="normal" style='text-align: left;'>
						µ<br>*
			...
			<div class="mtrow"
				...
				<div id="jkeysemicolon" class="normal" style='text-align: left;'>
					.<br>;
				</div>
				<div id="jkeycolon" class="normal" style='text-align: left;'>
					/<br>:
				</div>
				<div id="jkeyexclam" class="normal" style='text-align: left;'>
					§<br>!
				</div>
				<div id="jkeyshiftd" class="normal"
					style="width: 115px; border-right-style: solid;">Maj</div>
			</div>
			<div class="mtrow"
				style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
				...
				<div id="jkeyaltgr" class="normal"
					style="font-size: 15px !important; color: blue; width: 55px;">Alt
					Gr</div>
				<div id="jkeyfn" class="normal" style="width: 50px;">Win</div>
