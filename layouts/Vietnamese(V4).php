...
">
	<div id="keyboard" class="keyboardback">
		Vietnamese(V4) Keyboard Layout<br>
		<section>
			<div class="mtrow"
				...
				<div id="jkey1" class="normal" style='text-align: right;'>
					Ă<span style="color: blue">&nbsp;&nbsp;&nbsp;! <br>1
					</span>
				</div>
				<div id="jkey2" class="normal" style='text-align: right;'>
					Â<span style="color: blue">&nbsp;&nbsp;@ <br>2
					</span>
				</div>
				<div id="jkey3" class="normal" style='text-align: right;'>
					Ê<span style="color: blue">&nbsp;&nbsp;&nbsp;# <br>3
					</span>
				</div>
				<div id="jkey4" class="normal" style='text-align: right;'>
					Ô<span style="color: blue">&nbsp;&nbsp;&nbsp;$ <br>4
					</span>
				</div>
				<div id="jkey5" class="normal" style='text-align: right;'>
					̀ <span style="color: blue">&nbsp;&nbsp;&nbsp;% <br>5
					</span>
				</div>
				<div id="jkey6" class="normal" style='text-align: right;'>
					̉ <span style="color: blue">&nbsp;&nbsp;&nbsp;^ <br>6
					</span>
				</div>
				<div id="jkey7" class="normal" style='text-align: right;'>
					̃ <span style="color: blue">&nbsp;&nbsp;&nbsp;& <br>7
					</span>
				</div>
				<div id="jkey8" class="normal" style='text-align: right;'>
					́ <span style="color: blue">&nbsp;&nbsp;&nbsp;* <br>8
					</span>
				</div>
				<div id="jkey9" class="normal" style='text-align: right;'>
					̣ <span style="color: blue">&nbsp;&nbsp;&nbsp;( <br>9
					</span>
				</div>
				<div id="jkey0" class="normal" style='text-align: right;'>
					Đ<span style="color: blue">&nbsp;&nbsp;&nbsp;) <br>0
					</span>
				</div>
			...
			<div class="mtrow"
				...
				<div id="jkeyenter" class="normal"
					style="width: 95px; text-align: left;">Enter</div>
			</div>

			<div class="mtrow"
				style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
				<div id="jkeyshiftl" class="normal"
					style="width: 100px; text-align: left;">Shift</div>
