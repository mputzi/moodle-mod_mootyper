...
/**
 * This file defines the German(V4.2) keyboard layout.
 *
		...
		<section>
			...
			<div style="float: left;">
				...
				<div class="mtrow"
					...
					<div id="jkeycaps" class="normal"
						style="width: 72px; font-size: 10px !important;">Feststelltaste</div>
			...
			<div class="mtrow"
				...
				<div id="jkeyshiftd" class="normal"
					style="width: 105px; border-right-style: solid;">Umschalttaste</div>
			</div>
			<div class="mtrow"
				style='float: left; margin-left: 5px; font-size: 15px !important; line-height: 15px'>
