...
/**
 * This file defines the Arabic(V4.1)keyboard layout.
 *
	...
	<div id="keyboard" class="keyboardback">
		...
		<section>
			<div class="mtrow"
				...
				<div id="jkeyr10" class="normal" style='text-align: left;'>
					ّ<br>ذ&nbsp;
				</div>
			</div>
			<div class="mtrow"
				...
				<div id="jkeyد" class="normal" style='text-align: left;'>
					&gt;<br>د
				</div>
				<div id="jkeyج" class="normal" style='text-align: left;'>
					&lt;<br>ج
				</div>
			...
			<div class="mtrow"
				...
				<div id="jkeyط" class="normal" style='text-align: left;'>
					"<br>ط
				</div>
				<div id="jkeyك" class="finger4" style='text-align: left;'>
					:<br>&nbsp;&nbsp;&nbsp;ك
				</div>
			...
			<div class="mtrow"
				...
				<div id="jkeyظ" class="normal" style='text-align: left;'>
					؟<br>ظ
				</div>
