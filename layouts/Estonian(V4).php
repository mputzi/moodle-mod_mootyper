...
/**
 * This file defines the Estonian(V4.2) keyboard layout.
 *
...
">
	<div id="keyboard" class="keyboardback">
		Estonian(V4) Keyboard Layout<br>
		<section>
			<div class="mtrow"
				...
				<div id="jkeyaccent" class="normal"
					style='text-align: left; color: red'>
					`<br>´
				</div>
			...
			<div style="float: left;">
				<div class="mtrow"
					...
					<div id="jkeyõ" class="normal" style='text-align: left;'>
						Õ<br> <span style="color: blue">&nbsp; &nbsp; &nbsp;§</span>
					</div>
				</div>
				...
				<div class="mtrow"
					...
					<div id="jkeys" class="finger3" style='text-align: left;'>
						S<br> <span style="color: blue">&nbsp; &nbsp; &nbsp;š</span>
					</div>
					...
					<div id="jkeyö" class="finger4" style='text-align: left;'>
						Ö<br>&nbsp; &nbsp; &nbsp;
					</div>
					<div id="jkeyä" class="normal" style='text-align: left;'>
						Ä<br> <span style="color: blue">&nbsp; &nbsp; &nbsp;^</span>
					</div>
			...
			<div class="mtrow"
				...
				<div id="jkeyz" class="normal" style='text-align: left;'>
					Z<br> <span style="color: blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ž</span>
				</div>
