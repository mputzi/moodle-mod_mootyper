...
/**
 * This file defines the Portuguese(BrazilV5.2) keyboard layout.
 *
...
">
	<div id="keyboard" class="keyboardback">
		Portuguese(BrazilV5) Keyboard Layout<br>
		<section>
			<div class="mtrow"
				...
				<div id="jkey2" class="normal" style='text-align: left;'>
					@<br>2 <span tyle="color:blue">&nbsp;&nbsp;&nbsp;²</span>
				</div>
				<div id="jkey3" class="normal" style='text-align: left;'>
					#<br>3 <span tyle="color:blue">&nbsp;&nbsp;&nbsp;³</span>
				</div>
				...
				<div id="jkey6" class="normal" style='text-align: left;'>
					<span style="color: red">¨ </span><br>6 <span style="color: blue">&nbsp;&nbsp;¬</span>
				</div>
			...
			<div style="float: left;">
				<div class="mtrow"
					...
					<div id="jkeybracketl" class="normal"
						style='text-align: left; font-size: 15px !important; line-height: 15px'>
						{ <br>[<span style="color: blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ª</span>
					</div>
				</div>
				...
				<div class="mtrow"
					...
					<div id="jkeyç" class="finger4" style='text-align: left;'>
						Ç<br>&nbsp;
					</div>
					<div id="jkeytilde" class="normal" style='text-align: left;'>
						<span style="color: red">^<br> <span style="color: red"> ~</span>
					
					</div>
					<div id="jkeybracketr" class="normal" style='text-align: left;'>
						}<br>] <span style="color: blue">&nbsp;&nbsp;&nbsp;º</span>
					</div>
				</div>
			</div>
			...
			<div class="mtrow"
				...
				<div id="jkeyshiftr" class="normal" style="width: 65px;">Shift</div>
			</div>
