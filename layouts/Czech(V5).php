...
/**
 * This file defines the Czech(V5.2) keyboard layout.
 *
			...
			<div style="float: left;">
				<div class="mtrow"
					...
					<div id="jkeyw" class="normal" style='text-align: left;'>
						W <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: blue">|</span>
					</div>
					...
					<div id="jkeyú" class="normal" style='text-align: left;'>
						/<br>ú <span style="color: blue">&nbsp;&nbsp;÷</span>
					</div>
				...
				<div class="mtrow"
					...
					<div id="jkeyk" class="finger2" style='text-align: left;'>
						K <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: blue">ł</span>
					</div>
					...
					<div id="jkey§" class="normal" style='text-align: left;'>
						! <br>§&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: blue">ß</span>
					</div>
