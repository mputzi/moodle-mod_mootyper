...
/**
 * This file defines the Romanian(V4.1) keyboard layout.
 *
...
?>
">
<div id="keyboard" class="keyboardback">Romanian(V4) Keyboard Layout<br>
    <section>
    ...
    <div style="float: left;">
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
            ...
            <div id="jkeyp" class="normal" style='text-align:left;'>P<br>&nbsp;&nbsp;&nbsp;&nbsp;
                <span style="color:blue">§</span></div>
            <div id="jkeyš" class="normal" style='text-align:left;'>Ă
                <span style="color:blue">&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;[</span></div>
            <div id="jkeyđ" class="normal" style='text-align:left;'>Î
                <span style="color:blue">&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;]</span></div>
        </div>
        ...
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
            ...
            <div id="jkeyč" class="finger4" style='text-align:left;'>Ș&nbsp;&nbsp;&nbsp;
                <span style="color:blue">:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;;</span></div>
            <div id="jkeyć" class="normal" style='text-align:left;'>Ț&nbsp;&nbsp;&nbsp;
                <span style="color:blue">"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'</span></div>
        ...
        <div class="mtrow" style='float: left; margin-left:5px; font-size: 15px !important; line-height: 15px'>
            ...
            <div id="jkeyy" class="normal" style='text-align:left;'>Z<br>&nbsp;</div>
