...
/**
 * This file defines the Uygher(V4.2)Dual keyboard layout.
 *
...
">
	<div id="keyboard" class="keyboardback">
		Uygher(V4)Dual Keyboard Layout<br>
		<section>
			<div class="mtrow"
			...
			<div class="mtrow"
				...
				<div id="jkeyپ" class="normal" style='text-align: left;'>
					P<br>&nbsp;پ
				</div>
				<div id="jkeyو" class="normal" style='text-align: left;'>
					O<br>&nbsp;و
				</div>
				<div id="jkeyڭ" class="normal" style='text-align: left;'>
					I<br>&nbsp;ڭ
				</div>
				<div id="jkeyۇ" class="normal" style='text-align: left;'>
					U<br>&nbsp;ۇ
				</div>
				<div id="jkeyي" class="normal" style='text-align: left;'>
					Y<br>&nbsp;ي
				</div>
				<div id="jkeyت" class="normal" style='text-align: left;'>
					T<br>&nbsp;ت
				</div>
				<div id="jkeyر" class="normal" style='text-align: left;'>
					R<br>&nbsp;ر
				</div>
				<div id="jkeyې" class="normal" style='text-align: left;'>
					E<br>&nbsp;ې
				</div>
				<div id="jkeyۋ" class="normal" style='text-align: left;'>
					W<br>&nbsp;ۋ
				</div>
				<div id="jkeyچ" class="normal" style='text-align: left;'>
					Q<br>&nbsp;چ
				</div>
			...
			<div class="mtrow"
				...
				<div id="jkey؛" class="finger4" style='text-align: left;'>
					:<br>؛&nbsp; &nbsp; &nbsp;
				</div>
				<div id="jkeyl" class="finger3" style='text-align: left;'>
					L<br>ل&nbsp;
				</div>
				<div id="jkeyك" class="finger2" style='text-align: left;'>
					K<br>ك&nbsp;
				</div>
				<div id="jkeyق" class="finger1" style='text-align: left;'>
					J<br>ق&nbsp;
				</div>
				<div id="jkeyى" class="normal" style='text-align: left;'>
					H<br>ى&nbsp;
				</div>
				<div id="jkeyە" class="normal" style='text-align: left;'>
					G<br>ە&nbsp;
				</div>
				<div id="jkeyf" class="finger1" style='text-align: left;'>
					F<br>ا&nbsp;
				</div>
				<div id="jkeyد" class="finger2" style='text-align: left;'>
					D<br>د&nbsp;
				</div>
				<div id="jkeyس" class="finger3" style='text-align: left;'>
					S<br>س&nbsp;
				</div>
				<div id="jkeyھ" class="finger4" style='text-align: left;'>
					A<br>ھ&nbsp;
				</div>
			...
			<div class="mtrow"
				...
				<div id="jkeyئ" class="normal" style='text-align: left;'>
					؟<br>ئ&nbsp; &nbsp; &nbsp;
				</div>
				<div id="jkey." class="normal" style='text-align: left;'>
					<b>&gt;<br>.&nbsp; &nbsp; &nbsp;
				...
				<div id="jkeyم" class="normal" style='text-align: left;'>
					M<br>م&nbsp;
				</div>
				<div id="jkeyن" class="normal" style='text-align: left;'>
					N<br>ن&nbsp;
				</div>
				<div id="jkeyب" class="normal" style='text-align: left;'>
					B<br>ب&nbsp;
				</div>
				<div id="jkeyۈ" class="normal" style='text-align: left;'>
					V<br>ۈ&nbsp;
				</div>
				<div id="jkeyغ" class="normal" style='text-align: left;'>
					C<br>غ&nbsp;
				</div>
				<div id="jkeyش" class="normal" style='text-align: left;'>
					X<br>ش&nbsp;
				</div>
				<div id="jkeyز" class="normal" style='text-align: left;'>
					Z<br>ز&nbsp;
				</div>
