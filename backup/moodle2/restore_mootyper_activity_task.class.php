...
class restore_mootyper_activity_task extends restore_activity_task {
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('mootyper', 'add question', 'view.php?id={course_module}', '{mootyper}');
        $rules[] = new restore_log_rule('mootyper', 'update vote', 'view.php?id={course_module}', '{mootyper}');
        $rules[] = new restore_log_rule('mootyper', 'add round', 'view.php?id={course_module}', '{mootyper}');
    ...
    static public function define_restore_log_rules_for_course() {
        ...
        $rules[] = new restore_log_rule('mootyper', 'view all', 'index?id={course}', null,
                                        null, null, 'index.php?id={course}');
        $rules[] = new restore_log_rule('mootyper', 'view all', 'index.php?id={course}', null);
